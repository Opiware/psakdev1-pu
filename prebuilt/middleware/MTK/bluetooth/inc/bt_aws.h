 ...
 * @{
 * The Advanced Wireless Stereo (AWS) is MTK proprietary profile that defines the minimum set of functions such that two devices can transfer the audio data and synchronize the audio status.
 *
 * Terms and Acronyms
 * ======
 * |Terms                         |Details                                                                 |
