 ...
 * @{
 * This section introduces the PPG control APIs including terms and acronyms, control flow, supported features, PPG function groups, enums, structures and functions. The PPG control library is applied to enhance the PPG signal quality acquired from MTK MT2511.
 * 
 ...
 * Step2: Call #ppg_control_process() to analyze the incoming PPG data and adjust the setting of analog front-end on MTK MT2511. \n
 * 
 *  - sample code:
 *    @code 
 *
...
/** @brief This enum defines the target MTK MT2511 bio-application. */
typedef enum{
...
ppg_control_status_t ppg_control_init(void);
 ...
 /** 
 * @brief Call this function to analyze the incoming PPG data and automatically adjust the setting of analog front-end on MTK MT2511. 
 * @param[in] *ppg_control_input is the input data structure containing the actual data to be processed by this API, in order to adjust the setting of the the analog front-end on MTK MT2511.
