 ...
 * |\b BISI            | Beat Interval and Signal Integrity. This is a proprietary signal in MTK Clover. |
 ...
 * - For SS, sleep features with corresponding timestamp should be stored and uploaded to MTK Cloud for final sleep states (ex: #SS_AWAKE, #SS_REM, #SS_LIGHT, and #SS_DEEP ...etc.) \n
 *
 ...
 *  - step10: Use #check_fet_ready to see if any sleep feature is ready to store or upload to MTK Cloud. #send_fet_packet is designed to get sleep features.
