...
/**
* @brief This function gets MTK Smart Connection RX Filter used in the Wi-Fi driver.
* When MTK Smart Connection filter is enabled, the data frames with
...
/**
* @brief This function sets MTK Smart Connection RX Filter used in the Wi-Fi driver.
* This operation takes effect immediately.
* When MTK Smart connection filter is enabled, MTK Smart Connection packets will be delivered to the RX queue directly,
