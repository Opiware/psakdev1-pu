...
** 	
** 	1) Purpose:
** 	Enabled the MTK proprietary WiFi zero config feature
** 	2) Changed function name:
** 	patch_Config.h
** 	3) Code change description brief:
** 	MTK proprietary WiFi zero config feature enabled
** 	4) Unit Test Result:
** 	PASS
** 	
** 	<CRID START> <CRID END>
...
** 	
** 	1) Purpose:
** 	Disable the MTK proprietary WiFi zero config feature
** 	2) Changed function name:
** 	Patch_config.h
** 	3) Code change description brief:
** 	Disable the MTK proprietary WiFi zero config feature
...
/* Configure Free - MTK proprietary WiFi zero config (invented by Michael Rong) */
