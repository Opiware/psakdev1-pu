...
@par Overview
  - This project is a reference application on how to obtain heart rate (HR)
    and blood pressre (BP) data from MTK MT2511 biosensor daughterboard.
...
@par Hardware and software environment
  - Supported HDK
    - LinkIt 2523 HDK.
    - MTK MT2511 biosensor daughterboard (model number: MTK0067).
    - Optical module sub-board (model number: WS3524).
    - An electrocardiography (EKG) cable.
  - Environment configuration
    - Connect MTK MT2511 biosensor daughterboard to the LinkIt 2523 HDK
  ...
  - Customization Option
    ...
    - \b MTK_SENSOR_BIO_USE_MT2511 selects and enables the driver for
      MTK MT2511 biosensor. Please make sure MTK MT2511 biosensor
      daughterboard is connected to the LinkIt 2523 HDK.
    - \b FUSION_HEART_RATE_MONITOR_USE enables MTK heart rate monitor
      fusion algorithm library under
      middleware/MTK/sensor_subsys/lib/fusion_algo folder.
    - \b FUSION_HEART_RATE_VARIABILITY_USE enables MTK heart rate
      ...
      exclusively.
    - \b FUSION_BLOOD_PRESSURE_USE enables MTK blood pressure monitor
      fusion algorithm library under
      middleware/MTK/sensor_subsys/lib/fusion_algo folder. Please note that
...
@par Directory contents
  - Source and header files
    ...
    - \b \<sdk_root\>/driver/board/component/biosensor/mt2511:
      The driver of MT2511 (MTK  biosensing analog front-end chip).
