...
@par Overview
  ...
  - Application features
    ...
    - Sensor Subsystem. Demonstrates how to obtain sensor data from physical
      ...
      the sensor data. MTK MT2511 biosensor daughterboard is required to
...
@par Hardware and software environment
  - Supported platform
    ...
    - LCM module driven by Sitronix ST7789H2 (or another driver IC that
      supports MTK 2-data lane interface).
  ...
  - Environment configuration
    ...
    - Special Easy PinMux Tool (EPT) file configuration
      - A special EPT file is required for the connection to MTK MT2511
