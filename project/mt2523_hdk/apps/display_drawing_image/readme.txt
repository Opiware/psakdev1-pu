...
@par Overview
  ...
  - Application features
    - The application automatically detects two different output interfaces
      MTK serial interface (240x240) and MIPI interface (320x320), then
      displays the images with different resolutions based on the interface
      selection.
  - Results
    - The LCM displays and switches between MTK logo and LinkIt logo
      every 5 seconds.
...
@par Directory contents
  - Source and header files
    ...
    - \b src/logo_240X240.c:      Raw data of MTK logo in RGB565 format
                                  with resolution of 240x240.
    - \b src/logo_320X320.c:      Raw data of MTK logo in RGB565 format
                                  with resolution of 320x320.
...
@par Run the application
  ...
  - Run the application and observe the result. The LCM switches between
    MTK logo and LinkIt logo every 5 seconds.
*/
/**
 * @}
 * @}
