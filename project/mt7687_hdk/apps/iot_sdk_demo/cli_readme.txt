...
@par Supported commands
 ...
 Example: 
      ...
      - wifi config get mtksmart
        <flag>: 0:  disable; 1:  enable.   Set  MTK Smart Connection Filter.
        Example:
        wifi config set mtksmart 1    : Enable MTK Smart Connection Filter to cooperate with the 
                                        RX filter set by the command: wifi config set rxfilter <flag>.
        wifi config set mtksmart 0    : Disable MTK Smart Connection Filter.
      ...
      - wifi wps get device_info
        Example:
        wifi wps set device_info "MTK IoT Demo" "MTK Demo" "MTK Wireless Device Demo" "MTK7687 Demo" "123456789" : Set the five WPS information fields.
   ...
   - 'smart' commands
      - This command configures the device without input interface to connect to the wireless network.
        ...
        User can get the Elian android APK under the path of MT7687 <sdk_root>\tools\elian, where the Smart Connection libraries for
