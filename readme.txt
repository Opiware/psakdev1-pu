LinkIt(TM) Development Platform for RTOS provides a comprehensive software solution for devices based
...
2. Folder structure
  ...
  \middleware\MTK           ->  middleware. Read readme.txt in each module for details. 
