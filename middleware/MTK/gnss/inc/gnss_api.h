 ...
 * For more details on the data format, data flow and other information on GNSS, please refer to LinkIt™ Development Platform for RTOS GNSS Developer's Guide.
 *
 * Terms and Acronyms
 * ======
 * |Terms                   |Details                                                                 |
 ...
 * |\b PMTK                 | PMTK command is MTK proprietary data transfer protocol for GNSS. It enables configuring the parameters of the GNSS chipset, aiding assistance position information and receive notifications from the GNSS chip.</a>.|
 ...
 * Packet Type: 740 PMTK_DT_UTC Time aiding. The packet contains the current UTC time.\n
  *\n
 * For the details on the command, please refer to LinkIt™ Development Platform for RTOS GNSS Developer's Guide.
 ...
 *        The NMEA sentence: "$GPGGA,030544.713,,,,,0,0,,,M,,M,,*4B", For more details about NMEA, please refer to LinkIt™ Development Platform for RTOS GNSS Developer's Guide.
