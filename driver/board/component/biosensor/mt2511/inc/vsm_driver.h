...
typedef enum
{
	VSM_TIA_GAIN_10_K =   5,    /**<  TIA GAIN 10 k??. */
	VSM_TIA_GAIN_25_K =   4,    /**<  TIA GAIN 25 k??. */
	VSM_TIA_GAIN_50_K =   3,    /**<  TIA GAIN 50 k??. */
	VSM_TIA_GAIN_100_K =  2,    /**<  TIA GAIN 100 k??. */
	VSM_TIA_GAIN_250_K =  1,    /**<  TIA GAIN 250 k??. */
	VSM_TIA_GAIN_500_K =  0,    /**<  TIA GAIN 500 k??. */
	VSM_TIA_GAIN_1000_K = 6     /**<  TIA GAIN 1000 k??. */
} vsm_tia_gain_t;
