 ...
 *
 * - \b Introduction \n
 *   LinkIt™ SDK hardware abstraction layer (HAL) driver is embedded software ensuring maximized portability across IoT portfolio designed for LinkIt for real-time OS (RTOS) development platform.\n
 ...
 *   The HAL layer provides a generic set of APIs to interact with the upper layers, such as application, middleware and the OS. The APIs are defined interfaces for MTK IoT portfolio, so the upper layer written with the HAL API is portable across the MTK IoT platforms.\n
